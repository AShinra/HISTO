...
def summary(client):
    ...
    with selection_col:
        ...
        with st.spinner('Processing Data', show_time=True):
            ...
            coltiera1, coltiera2 = st.columns([0.35, 0.65], border=True)
            with coltiera1:
                with st.popover(
                    label='Details'
                ):
            ...
            coltierb1, coltierb2 = st.columns([0.35, 0.65], border=True)
            with coltierb1:                            
                with st.popover(
                    label='Details'
                ):
            ...
            coltierc1, coltierc2 = st.columns([0.35, 0.65], border=True)
            with coltierc1:
                with st.popover(
                    label='Details'
                ):
            ...
            coltierd1, coltierd2 = st.columns([0.35, 0.65], border=True)
            with coltierd1:
                with st.popover(
                    label='Details'
                ):
